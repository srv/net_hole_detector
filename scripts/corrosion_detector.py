...
# Import new messages
from net_hole_detector.msg import BoundingBox, BoundingBoxArray, NetStats
...
class BboxDetector:
    def __init__(self):
        ...
        self.model = torch.hub.load(repo_or_dir=DINOV3_LOCATION, model=MODEL_NAME, source="local")
        self.model.cuda()
        self.model.eval()
